...
import { NYS_RIS as SCHEMA } from '../../../src/constants/databaseSchemaNames';
...
export function getFeatures(ids: string[]) {
  const rawTargetMapFeatures = targetMapDao.getRawEdgeFeatures(ids);
