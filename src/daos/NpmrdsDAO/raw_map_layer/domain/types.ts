...
// NOTE: TmcIdentification is the prefer metadata source for TMCs.
...
export interface NpmrdsTmcFeature
  extends turf.Feature<turf.LineString | turf.MultiLineString> {
  id: TmcIdentificationProperties['tmc'];
  properties: TmcIdentificationProperties & { lineartmc: string };
}
