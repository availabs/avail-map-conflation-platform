...
DROP TABLE IF EXISTS __SCHEMA__.shst_metadata ;

CREATE TABLE __SCHEMA__.shst_metadata (
  _id                 INTEGER PRIMARY KEY AUTOINCREMENT,
  geometry_id         TEXT,
  osm_metadata_name   TEXT -- SharedStreetsMetadata.OSMMetadata.name property
) ;

-- For JOINing with __SCHEMA__.shst_geometries
CREATE INDEX __SCHEMA__.shst_metadata_geometry_id_idx
...
DROP TABLE IF EXISTS __SCHEMA__.shst_metadata_gis_metadata;

CREATE TABLE __SCHEMA__.shst_metadata_gis_metadata (
...
DROP TABLE IF EXISTS __SCHEMA__.shst_metadata_osm_metadata_way_section_nodes ;

CREATE TABLE __SCHEMA__.shst_metadata_osm_metadata_way_section_nodes (
  shst_metadata_id               INTEGER,
  osm_metadata_way_section_idx   INTEGER,
...
DROP TABLE IF EXISTS __SCHEMA__.shst_metadata_gis_metadata_section_metadata;

CREATE TABLE __SCHEMA__.shst_metadata_gis_metadata_section_metadata (
  shst_metadata_id            INTEGER,
  gis_metadata_idx            INTEGER,
